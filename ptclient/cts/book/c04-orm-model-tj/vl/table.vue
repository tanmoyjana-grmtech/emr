<template>
 ...
 -->
  <div>
    From tj lession04 - {{ cfMsg }}
    <el-button style="padding: 3px;" type="success" plain @click="mfOpenCtInCl">A</el-button>
  </div>
</template>
<script>
import ormHelloWorld from '@/cts/book/c04-orm-model-tj/db/vuex-orm/helloworld.js'
export default {
  computed: {
    /**
    ...
    cfMsg() {
       ...
       * return : the cfMsg will return the stored value by ORM in the template line 9 cfMsg variable
       */
  ...
  mounted() {
     ...
     */
    ormHelloWorld.insert({ data: { id: 1, msg: 'tj05' } })
  },
  methods: {
    /**
    ...
    mfOpenCtInCl() {
      this.$store.commit('mtfShowNewFirstTabInClFromSearchPhrase', {
        searchTerm: 'Fourth chapter tj - change',
      })
    },
  },
}
