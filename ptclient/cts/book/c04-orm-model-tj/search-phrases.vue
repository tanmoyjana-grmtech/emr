...
export default {
  ...
  mounted() {
    ...
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Fourth chapter - tj',
        ctAbbr: 'c4',
        ctToShow: 'book/c04-orm-model-tj/vl/table.vue', // CsVl -> Current state view layer
        displayLocation: 'ptsvl',
      },
    })
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Fourth chapter tj - change',
        ctAbbr: 'c4-c',
        ctToShow: 'book/c04-orm-model-tj/cl/table.vue',
        displayLocation: 'cl',
        ctWidthInCl: 'small',
      },
    })
