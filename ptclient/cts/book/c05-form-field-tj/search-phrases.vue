...
export default {
  ...
  mounted() {
    ...
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Fifth chapter tj',
        ctAbbr: 'c5',
        ctToShow: 'book/c05-form-field-tj/vl/table.vue', // CsVl -> Current state view layer
        displayLocation: 'ptsvl',
      },
    })
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Fifth chapter tj - change',
        ctAbbr: 'c5-c',
        ctToShow: 'book/c05-form-field-tj/cl/table.vue',
        displayLocation: 'cl',
        ctWidthInCl: 'small',
      },
    })
