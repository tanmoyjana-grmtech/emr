...
export default {
  ...
  mounted() {
    ...
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Eigth chapter tj',
        ctAbbr: 'c8',
        ctToShow: 'book/c08-reset-form-tj/vl/table.vue', // CsVl -> Current state view layer
        displayLocation: 'ptsvl',
      },
    })
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Eigth chapter tj - change',
        ctAbbr: 'c8-c',
        ctToShow: 'book/c08-reset-form-tj/cl/table.vue',
        displayLocation: 'cl',
        ctWidthInCl: 'small',
      },
    })
