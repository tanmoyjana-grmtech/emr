...
export default {
  ...
  mounted() {
    ...
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Tenth chapter tj',
        ctAbbr: 'c10',
        ctToShow: 'book/c10-system-versioned-vl-data-tj/vl/table.vue', // CsVl -> Current state view layer
        displayLocation: 'ptsvl',
      },
    })
    ormSearchPhrasesOfCt.insert({
      data: {
        value: 'Tenth chapter tj - change',
        ctAbbr: 'c10-c',
        ctToShow: 'book/c10-system-versioned-vl-data-tj/cl/table.vue',
        displayLocation: 'cl',
        ctWidthInCl: 'small',
      },
    })
